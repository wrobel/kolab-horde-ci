# Variables
%define         V_package Horde_Nls-H4

%define         V_pear_package Nls
%define         V_package_url http://pear.horde.org/Nls
%define         V_version 0.1.0dev201012061502
%define         V_release 1
...
%define         V_summary This package provides Native Language Support (NLS).
...
%description 
Provide common methods for handling language data, timezones, and hostname->country lookups.
