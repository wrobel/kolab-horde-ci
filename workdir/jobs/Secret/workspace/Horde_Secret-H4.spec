# Variables
%define         V_package Horde_Secret-H4

%define         V_pear_package Horde_Secret
%define         V_package_url http://pear.horde.org/Horde_Secret
...
%define         V_summary Secret Encryption API
