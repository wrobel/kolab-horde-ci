# Variables
%define         V_package Horde_Editor-H4

%define         V_pear_package Horde_Editor
%define         V_package_url http://pear.horde.org/Horde_Editor
...
%define         V_summary Horde Editor API
