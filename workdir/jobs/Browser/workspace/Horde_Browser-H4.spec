# Variables
%define         V_package Horde_Browser-H4

%define         V_pear_package Horde_Browser
%define         V_package_url http://pear.horde.org/Horde_Browser
...
%define         V_summary Horde Browser API
