...
%define         V_pear_package Horde_Role
%define         V_package_url http://pear.horde.org/Horde_Role
%define         V_version 0.2.0dev201102221326
%define         V_release 1
...
%define         V_summary PEAR Installer role used to install Horde components
...
%description 
This package provides a method for PEAR to install Horde
