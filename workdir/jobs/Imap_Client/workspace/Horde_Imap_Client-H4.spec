# Variables
%define         V_package Horde_Imap_Client-H4

%define         V_pear_package Horde_Imap_Client
%define         V_package_url http://pear.horde.org/Horde_Imap_Client
%define         V_version 0.1.0dev201102221425
%define         V_release 1
...
%define         V_summary Horde IMAP abstraction interface
...
%description 
This package provides an abstracted API interface to various
