# Variables
%define         V_package Horde_Notification-H4

%define         V_pear_package Notification
%define         V_package_url http://pear.horde.org/Notification
...
%define         V_summary Horde Notification System
