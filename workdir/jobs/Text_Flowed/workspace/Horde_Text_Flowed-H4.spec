# Variables
%define         V_package Horde_Text_Flowed-H4

%define         V_pear_package Horde_Text_Flowed
%define         V_package_url http://pear.horde.org/Horde_Text_Flowed
%define         V_version 0.1.0dev201102221429
%define         V_release 1
...
%define         V_summary Horde API for flowed text as per RFC 3676
...
%description 
The Horde_Text_Flowed:: class provides common methods for
