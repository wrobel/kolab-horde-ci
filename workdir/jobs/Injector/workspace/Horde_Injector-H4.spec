# Variables
%define         V_package Horde_Injector-H4

%define         V_pear_package Horde_Injector
%define         V_package_url http://pear.horde.org/Horde_Injector
...
%define         V_summary Horde dependency injection container
