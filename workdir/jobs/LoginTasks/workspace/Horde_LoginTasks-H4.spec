...
%define         V_summary Horde Login Tasks System
...
%description 
The Horde_LoginTasks:: class provides a set of methods for dealing with tasks run upon login to Horde applications.
