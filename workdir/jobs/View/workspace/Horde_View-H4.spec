# Variables
%define         V_package Horde_View-H4

%define         V_pear_package Horde_View
%define         V_package_url http://pear.horde.org/Horde_View
%define         V_version 0.2.1dev201102221430
%define         V_release 1
...
%define         V_summary Horde View API
...
%description 
The Horde_View:: class provides a simple View pattern implementation.
