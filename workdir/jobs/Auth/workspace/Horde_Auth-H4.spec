# Variables
%define         V_package Horde_Auth-H4

%define         V_pear_package Horde_Auth
%define         V_package_url http://pear.horde.org/Horde_Auth
...
%define         V_summary Horde Authentication API
