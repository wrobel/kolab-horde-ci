...
%define         V_version 0.1.0dev201011291802
%define         V_release 1
...
%define         V_summary Horde Constraint library
...
%description 
This package provides a programmatic way of building constraints that evaluate to true or false
