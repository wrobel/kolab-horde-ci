# Variables
%define         V_package Horde_Stream_Wrapper-H4

%define         V_pear_package Horde_Stream_Wrapper
%define         V_package_url http://pear.horde.org/Horde_Stream_Wrapper
...
%define         V_summary Horde Stream filters
