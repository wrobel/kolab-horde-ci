...
PreReq: Horde_Stream_Wrapper-H4

# Package options
%option       with_chroot              no

%description 
This package provides supporting functionality for Horde that is not tied to Horde but is used by it. These classes can be used outside of Horde as well.
