# Variables
%define         V_package Horde_Perms-H4

%define         V_pear_package Horde_Perms
%define         V_package_url http://pear.horde.org/Horde_Perms
...
%define         V_summary Horde Permissions System
