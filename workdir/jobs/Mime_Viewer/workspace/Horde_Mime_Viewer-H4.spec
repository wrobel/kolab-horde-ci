# Variables
%define         V_package Horde_Mime_Viewer-H4

%define         V_pear_package Horde_Mime_Viewer
%define         V_package_url http://pear.horde.org/Horde_Mime_Viewer
%define         V_version 0.2.0dev201102221427
%define         V_release 1
...
%define         V_summary Horde MIME Viewer Library
...
PreReq: Horde_Compress-H4
PreReq: Horde_Exception-H4
PreReq: Horde_Mime-H4
PreReq: Horde_Text_Filter-H4
PreReq: Horde_Text_Flowed-H4
