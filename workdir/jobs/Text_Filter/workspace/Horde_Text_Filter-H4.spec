# Variables
%define         V_package Horde_Text_Filter-H4

%define         V_pear_package Horde_Text_Filter
%define         V_package_url http://pear.horde.org/Horde_Text_Filter
...
%define         V_summary Horde Text Filter API
...
%description 
The Horde_Text_Filter:: class provides common methods for
