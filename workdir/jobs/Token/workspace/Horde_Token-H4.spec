# Variables
%define         V_package Horde_Token-H4

%define         V_pear_package Horde_Token
%define         V_package_url http://pear.horde.org/Horde_Token
...
%define         V_summary Horde Token API
...
%description 
The Horde_Token:: class provides a common abstracted interface
