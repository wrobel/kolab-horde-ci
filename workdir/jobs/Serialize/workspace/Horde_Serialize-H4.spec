# Variables
%define         V_package Horde_Serialize-H4

%define         V_pear_package Horde_Serialize
%define         V_package_url http://pear.horde.org/Horde_Serialize
...
%define         V_summary Data Encapulation API
...
%description 
The Horde_Serialize:: class provides various methods of
 encapsulating data.
